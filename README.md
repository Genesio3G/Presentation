# Olá, eu sou o Genésio Gabriel 👋💻

### **Engenheiro de Informática | Programador Full-Stack & Help Desk**

Sou formado em **Engenharia de Informática** pela *Universidade Independente de Angola* e atualmente atuo como **Programador e Help Desk**. Sou apaixonado por resolver problemas complexos através da tecnologia, unindo a lógica da programação com a empatia do suporte ao cliente.
...
*   **🧠 Fácil capacidade de aprendizagem:** Sempre em busca de novas stacks e metodologias.
*   **🧩 Resolução de problemas complexos:** Abordagem analítica para bugs e desafios de infraestrutura.
*   **🤝 Trabalho em equipe:** Boas habilidades interpessoais e comunicação clara.
*   **💡 Inovação e Criatividade:** Capacidade de criar soluções do zero e otimizar processos.
*   **📅 Organização:** Gestão eficiente de tempo e tarefas.
*   **💪 Resiliência e Flexibilidade:** Adaptação rápida a mudanças e ambientes dinâmicos.
